...
/**
 * 
 * @param   {object}    account MetaMask account details
 * @param   {onClose}   onClose Sets modal visibility
 * @returns component   Returns add property modal component
 */
export default function AddPropertyModal({account, onClose}) {
    ...
    /**
     * Handles submit activity and adds
