 ...
 * object properties to empty string
 */
 ...
 * @param   {onClose}   onClose Sets modal visibility
 * @returns component   Returns edit property modal component
 */
export default function RegisterPropertyModal({property, onClose}) {
    ...
    /**
     * Handles submit event asynchronously and
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            /**
             * @param {int}     property.id Wrap property id to int
             * @param {int}     property.lotNum Wrap property lot number to int
             * @param {int}     property.surveyNum Wrap property survey number to int
             * @param {string}  property.area Wrap property area to string
             * @param {string}  property.location Wrap property location to string
             * @param {string}  property.locationDesc Wrap property location description to string
             * @param {string}  property.validator Wrap property field validator to string
             * @param {string}  deedDetails.owner Wrap property owner to string
             * @param {string}  deedDetails.ownerAddress Wrap property owner address to string
             * @param {int}     deedDetails.cadNum Wrap property cadastral number to int
             * @param {int}     deedDetails.lrcNum Wrap property lrc record number to int
             */
